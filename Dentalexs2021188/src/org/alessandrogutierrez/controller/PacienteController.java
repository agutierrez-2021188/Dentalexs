...
public class PacienteController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        fNacimiento.getStylesheets().add("/org/alessandrogutierrez/resource/DatePicker.css");
        ...
        fPV.getStylesheets().add("/org/alessandrogutierrez/resource/DatePicker.css");
    }
    ...
    public void nuevo(){
        switch(tipoDeOperacion){
            ...
            case GUARDAR:
                ...
                cargarDatos();
                break;
            // El cancelar esta en el boton de eliminar, es un metodo igual al nuevo(), su default es cancelar como en el nuevo es NINGUNO
    ...
    public void eliminar(){
        switch (tipoDeOperacion){
            ...
            default:
                if (tblPacientes.getSelectionModel().getSelectedItem() != null){ //Hay una seleccion
                    int respuesta = JOptionPane.showConfirmDialog(null, "¿Está seguro de eliminar el registro?", "Elimar Paciente", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
    ...
    public void imprimirReporte(){
        ...
        GenerarReporte.mostrarReporte("ReportePacientes.jasper", "Reporte de Pacientes", parametros); //Poner la ruta de las imagenes, ruta relativa
    }
